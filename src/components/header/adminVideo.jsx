...
import AddVideo from '../form/addVideo';
import { Playlist } from '../content/managerVideo';

export const AdminVideoHeader = () => {
    ...
    const search = () => {
        const keySearch = document.getElementById('search-bar').value;
            ...
            <header>
                ...
                <div className="function">
                    <div className="add-button" title="Tạo">
                        <img src="/images/plus.png" style={{ width: '30px', height: '30px' }} onClick={addVideo} alt="Tạo" />
                    </div>
                    <div className="alert-button" title="Thông báo">
                        <img src="/images/bell.png" style={{ width: '30px', height: '30px' }} alt="Thông báo" />
                    </div>
                    <img src={localStorage.getItem('avtUser')} style={{ width: '50px', height: '50px' }} onClick={accounts} alt="Avatar" />
                </div>
                <div className={`account ${isVisible ? 'visible' : ''}`}>
                    ...
                    <a href='/admin/video/setting'><div className="admin">Cài đặt</div></a>
                    <div className="logout" onClick={logout}>Đăng xuất</div>
                </div>
                <div className={`form ${formIsVisible ? 'visible' : ''}`}>
                    <div id="overlay" onClick={addVideo}></div>
                    <AddVideo />
                </div>
            </header>
            <main>
                <Playlist keySearch={keySearch} />
            </main>
        </div>
    );
};
